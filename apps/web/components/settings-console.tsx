...
const planCards = [
  ...
  },
  {
    ...
    includes: ["ATS", "Rewards", "Compliance", "Security", "Analytics"],
  },
];
...
export function SettingsConsole() {
  ...
  function load() {
    ...
    // Rules — accessible to any authenticated user (no settings.configure needed)
    ...
    // SaaS plan — accessible to any authenticated user
